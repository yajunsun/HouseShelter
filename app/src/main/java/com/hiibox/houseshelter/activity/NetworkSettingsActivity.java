...
public class NetworkSettingsActivity extends ShaerlocActivity implements IRegisterIOTCListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wifiAdmin = new WifiAdmin(NetworkSettingsActivity.this);
		dialog = new ProgressDialog(NetworkSettingsActivity.this);
		handler = new Handler();
    ...
    private void connectTargetWifi(String na, String pa) {
		...
		if (wifiAdmin.AddNetwork(cofg1)) {
			...
			handler.postDelayed(new Runnable() {
				...
				public void run() {
					...
					if (str.equals("COMPLETED")) {
						...
						Toast.makeText(getApplicationContext(), "链接成功",
								Toast.LENGTH_SHORT).show();
						Intent intent = new Intent(NetworkSettingsActivity.this,
								WifiListGet.class);
						...
						Toast.makeText(getApplicationContext(), "链接失败",
								Toast.LENGTH_SHORT).show();
						dialog.dismiss();
						finish();
			...
			Toast.makeText(getApplicationContext(), "链接出错！请手动链接",
					Toast.LENGTH_SHORT).show();
			// showInfo.setText(builder.toString());
		}
