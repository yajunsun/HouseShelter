...
public class ScanCodeActivity extends ShaerlocActivity implements Callback {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            MianActivity.getScreenManager().exitActivity(this);
        }
        return true;
    }
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(ret) || ret.length()!=20) {
